...
export default ($timeout) => ({
  ...
  link: (scope, element, attrs, ngModelCtrl) => {
     ...
     * @inner
     */
    const hasFocusInteger = () => document.activeElement === integerInput[0];

    /**
     * @return {boolean}
     * @inner
     */
    const hasFocusDecimal = () => document.activeElement === decimalInput[0];

    /**
     * @return {boolean}
     * @inner
     */
    const hasFocus = () => hasFocusInteger() || hasFocusDecimal();
