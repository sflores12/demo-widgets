...
})(this, function(__WEBPACK_EXTERNAL_MODULE_23__, __WEBPACK_EXTERNAL_MODULE_28__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vendorBbUibTooltip = __webpack_require__(28);
	
	var _vendorBbUibTooltip2 = _interopRequireDefault(_vendorBbUibTooltip);
	
	__webpack_require__(29);
	
	var _directive = __webpack_require__(31);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "ui-bb-ellipsis-tooltip-ng {\n  display: block;\n}\n", ""]);
...
/***/ (function(module, exports) {
	 ...
	 */
	var createClone = function createClone(element) {
	  var target = element.children();
	  var css = window.getComputedStyle(target[0], null);
	  var clone = target.clone();
	
	  for (var i = 0, name; i < css.length; i++) {
	    name = css.item(i);
	  ...
	  return {
	    ...
	    link: function link(scope, element) {
	      ...
	      element.on('mouseenter', function () {
	        ...
	        var cloneWidth = clone[0].offsetWidth;
