...
Angular UI Bootstrap position component written in pure AngularJS  based on Bootstrap's markup and CSS.
...
import uibPositionKey from 'vendor-bb-uib-position';
...
<a href="http://angular-ui.github.io/bootstrap/versioned-docs/1.3.3/#/position" target="_blank">official
